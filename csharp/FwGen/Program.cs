...
static class BridgeGen
{
    ...
    {
        var output = config.PathValue(root, "gen", "bridge_codec_cs", "csharp/bridge/codec/bridge_codec.cs");
        var rootNamespace = TextUtil.PascalName(config.Value("project", "name", "Game"));
        var text = new StringBuilder();
        text.AppendLine("// @generated by fw_gen bridge. Do not edit.");
        text.AppendLine("using Godot;");
    ...
    {
        var output = config.PathValue(root, "gen", "bridge_input_codec_cs", "csharp/bridge/codec/input_codec.cs");
        var files = new[]
        {
    ...
    {
        var output = config.PathValue(root, "gen", "bridge_event_codec_cs", "csharp/bridge/codec/event_codec.cs");
        var files = new[]
        {
            Path.Combine(schemaDir, "common.proto"),
